...
public class ItemizedListConverter implements Converter {

    private ItemizedListConverter() {}
    public static ItemizedListConverter INSTANCE = new ItemizedListConverter();
    @Override
    public void convert(Element element, TextStringBuilder adoc, Context context) throws ConversionException {
        ...
        List<Element> children = element.elements("listitem");
        for(Element child: children) {
            adoc.append("* ");
            ParagraphConverter.INSTANCE.convert(child, adoc, context);
        }
    }
}
